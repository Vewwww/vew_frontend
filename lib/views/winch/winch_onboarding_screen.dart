...
class WinchOnBoardingScreen extends StatefulWidget {
  const WinchOnBoardingScreen({Key? key}) : super(key: key);

  @override
  State<WinchOnBoardingScreen> createState() => _WinchOnBoardingScreenState();
}

class _WinchOnBoardingScreenState extends State<WinchOnBoardingScreen> {
